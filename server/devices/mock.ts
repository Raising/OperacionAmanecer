...
const MockDevices = () => {
    ...
    let devices: { [name: string]: any } = {
      M01: { "coord": { "y": 36.9788478, "x": -3.74469184 }, "deviceId": "M01", "time": 0, "intensity": -34, direction: [-moveStep / 2, -moveStep / 2] },
      M02: { "coord": { "y": 36.9788478, "x": -3.74489184 }, "deviceId": "M02", "time": 0, "intensity": -34, direction: [-moveStep / 2, -moveStep / 2] },
      M03: { "coord": { "y": 36.9788478, "x": -3.7459184 }, "deviceId": "M03", "time": 0, "intensity": -34, direction: [-moveStep / 2, -moveStep / 2] },
      K01: { "coord": { "y": 36.9881569, "x": -3.7425983 }, "deviceId": "K01", "time": 0, "intensity": -34, direction: [moveStep / 2, moveStep / 2] },
      K02: { "coord": { "y": 36.9881569, "x": -3.7424983 }, "deviceId": "K02", "time": 0, "intensity": -34, direction: [moveStep / 2, moveStep / 2] },
      K03: { "coord": { "y": 36.9881569, "x": -3.7423983 }, "deviceId": "K03", "time": 0, "intensity": -34, direction: [moveStep / 2, moveStep / 2] },
